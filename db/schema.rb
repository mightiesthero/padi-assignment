...
ActiveRecord::Schema.define(version: 2019_04_12_124524) do
  ...
  create_table "survey_images", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.binary "img"
    t.text "description"
  ...
  create_table "survey_sites", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "clientname"
    t.string "address"
    t.string "city"
    t.string "longitude"
  ...
  create_table "survey_technicians", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "survey_site_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
